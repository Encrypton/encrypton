...
def encrypt():
	...
	os.system("sudo rm /media/pi/MAIN/*")
	os.system("sudo rm /media/pi/MAIN1/*")
	os.system("sudo rm /media/pi/MAIN2/*")
...
def decrypt():
	...
	os.system("rm /media/pi/MAIN/encrypt0.7z")
	os.system("rm /media/pi/MAIN/encrypt1.7z")
	os.system("rm /media/pi/MAIN/encrypt2.7z")
